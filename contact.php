...
if (!isset($_POST['save']) || $_POST['save'] != 'contactform') {
    header('Location: http://debutproducts.com/contact-form-submission.php'); exit;
}
// get the posted data
...
if (isset($error)) {
    header('Location: http://debutproducts.com/contact-form-submission.php?e='.urlencode($error)); exit;
}
